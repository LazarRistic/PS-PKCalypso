...
class DatabaseRest
{
    ...
    {
        $DBinfo = new DBInfo();
        $this->hostname = $DBinfo->getDBHost();
        $this->username = $DBinfo->getDBUser();
        $this->password = $DBinfo->getDBPass();
...
//select funkcija
    function select ($table="dancer", $rows = 'dancer.id, dancer.firstname, dancer.lastname, dancer.age_group_id, dancer.class_id, age_group.name', $join_table="age_group", $join_key1="dancer.age_group_id", $join_key2="id", $where = null, $order = null)
    {
